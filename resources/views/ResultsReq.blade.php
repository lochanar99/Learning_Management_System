...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Request Result Sheet</title>  
										...
										<fieldset class="row-fluid">
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<select name="select_service" id="select_service" class="selectpicker form-control" data-style="btn-white">
															<option value="res1">Semester 01 Results </option>
															<option value="res2">Semester 02 Results </option>
															<option value="res3">Semester 03 Results </option>
															<option value="res4">Semester 04 Results </option>
															<option value="res4">ALL 04 Semester Results </option>
													</select>
												</div>
												
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<textarea class="form-control" name="ress" id="ress" rows="6" placeholder="Reason for Request"></textarea>
												</div>
