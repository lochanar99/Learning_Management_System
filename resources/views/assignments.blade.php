...
<body class="seo_version">
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-3.jpeg);">
...
<input type="text" class="form-control" name="assignment" placeholder="enter your assignment name">
<br>
<input type="text" class="form-control" name="assignment1" placeholder="enter your subject name">
<br>
