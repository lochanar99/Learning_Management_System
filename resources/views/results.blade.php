...
<body class="seo_version">
   ...
   <header class="header header_style_01">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <li><a href="/index">About</a></li>
                        ...
                        <li><a class="active" href="/exam">Exams/Assigments</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-6.jpeg);">
    ...
    <input type="text" class="form-control" name="q" placeholder="Search Students name"> <span class="input-group-bth">
...
<div class="container">
    <div class="row">
        ...
        @endforeach
            ...
            {{csrf_field()}}
            <input type="text" class="form-control" name="year1" placeholder="Enter the student's year...">
            <br>
            <input type="text" class="form-control" name="name1" placeholder="Enter the student's name...">
            <br>
            <input type="text" class="form-control" name="module1" placeholder="Enter the student's module...">
            <br>
            <input type="text" class="form-control" name="type1" placeholder="Enter the student's mark...">
            <br>
            ...
            <table class="table table-light">
                ...
                <tr>
                    ...
                    <td>{{$res->module}}</td>
                    <td>{{$res->resType}}</td>
                    <td> <a href="{[ url('/deleteResult',['Rid' => $results->Rid]}}" class="btn btn-warning">Delete</a>
                    <a href="/updateResult/{{$res->Rid}}" class="btn btn-success">Update</a></td>
                </tr>
                @endforeach
                </table>
        </div>
