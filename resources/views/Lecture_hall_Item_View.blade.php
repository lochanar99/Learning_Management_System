...
<head>
	...
	<title>Lecture Hall Item View</title>
	<meta charset="utf-8">
...
<body>
    ...
    <div class="all-page-title" style="background-image:url(images/deco.jpg);">
...
<br><br>
    ...
    <h2 align="center">Lecture Hall Items Update Delete Menu</h2>
  ...
  <tbody>
  @foreach($Lecture_hall_Item_View as $exp)
    <tr>
      ...
      <td><a href="/deleteTask/{{$exp->id}}" class="btn btn-warning">Delete</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
