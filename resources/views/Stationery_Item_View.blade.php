...
<html>
<head>
	<title>Stationery Item View</title>
	<meta charset="utf-8">
...
<body>
  ...
  <!-- LOADER -->
    ...
    <div class="all-page-title" style="background-image:url(images/deco7.jpg);">
    ...
    <h2 align="center">Stationery Items Update Delete Menu</h2>
    <br>
...
<!--table starts here-->
  ...
  <thead>
    <tr>
      ...
      <th scope="col">CurrentItem</th>
      <th scope="col">RequiredItem</th>
  ...
  <tbody>
  @foreach($Stationery_Item_View as $pp)
    <tr>
      <th scope="row">1</th>
      <td>{{$pp->ItemCode}}</td>
      <td>{{$pp->ItemName}}</td>
      <td>{{$pp->CurrentItem}}</td>
      <td>{{$pp->RequiredItem}}</td>
      <td>{{$pp->Quantity}}</td>
      <td>{{$pp->Status}}</td>
      <td><button type="button" name="" value="" class="btn btn-success">Update</button></td>
      <td><button type="button" name="" value="" class="btn btn-danger">Delete</button></td>
    </tr>
   @endforeach
  </tbody>
</table>
