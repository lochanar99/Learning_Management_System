...
<body class="seo_version">
    ...
    <div class="all-page-title" style="background-image:url(images/pattern.png);">
    ...
    <div class="contain_links" align="center">
            ...
            <div class="row">
				<div class="col-md-6 m40">
                    <div class="message-box">
                        ...
                        <p> Page describe briefly about the Inventories, Items, Equipments, Stationeries in the System. Through this pages Lecturer can add, update, delete and read data which is interact with the dayabase.Lecturer can manipulate data in the fileds of Lecture halls, Labs and Statiories in the lecture halls. </p>
    ...
    <!--content of the page about page-->
