        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <img src="uploads/ITS1.png" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3>Wi-Fi Portal</h3>
                        <p>User Name - Your User ID</p>
						<p>Password - Your NIC Number</p>
						<p>IP Address - 192.168.16.0</p>
                    </div><!-- end service -->
                </div><!-- end col -->
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <img src="uploads/ITS2.png" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3>Service Guide</h3>
                        <p>The Guide</p>
						<p>For IT services</p>
