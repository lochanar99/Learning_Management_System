...
<body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        <li><a href="/index1">About</a></li>
                        <li><a href="about.html">Profile </a></li>
                        <li><a href="services.html">Lectures</a></li>
                        <li><a href="case-study.html">Event/extra Lectures</a></li>
                        <li><a href="pricing.html">Student affair/digital Library</a></li>
                        <li><a href="contact.html">Student Management</a></li>
    ...
    <br> <br> <br> <br> <br> <br> <br> <br> <br>
     ...
     <div class="all-page-title" style="background-image:url(images/stationery.jpg);">
	...
	<li><a href="/labItem">Lab Item</a></li>

	<li><a class="active" href="stationeryItem">Stationery Item</a></li>
    ...
    <h2 align="center">Stationery Items</h2>

	<!--starting form-->
    <div class="Stationery_form">
    <div class="container text-center">
    ...
    {{csrf_field()}}
		...
		<input type="text" name="sta" value="" placeholder="Enter item code" >
		<br>
		<label>Item Name</label>
		<input type="text" name="staname" value="" placeholder="Enter item name" >
		<br>
		<label>Current Item</label>
		<input type="text" name="stacur" value="" placeholder="Enter number of current items">
		<br>
		<label>Required Item</label>
		<input type="text" name="stareq" value="" placeholder="Enter number of required items">
		<br>
		<label>Quantity</label>
		<input type="text" name="staqty" value="" placeholder="Enter Quantity">
		<br>
		<label>Status</label>
    ...
    <div class="col-auto my-1">
      ...
      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="stadrop">
        ...
        <a href="/Stationeryview"><button  type="button" class="btn btn-danger btn-primary btn-lg" >Update/Delete</button></a>
