...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Digital Library and Student Affairs</title>  
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href='DigitalLibrary'> <img src="uploads/Library.jpg" alt="" class="img-responsive img-rounded"  >
                        </div>
                        <h3><a href='DigitalLibrary'>Digital Library</h3>
                    </div><!-- end service -->
                </div><!-- end col -->
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href='StudentAffairs'> <img src="uploads/studentAffairs.jpg" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3> <a href='StudentAffairs'> Student Affairs</h3>
						</div><!-- end service -->
                </div><!-- end col -->
            </div><!-- end row -->
