...
<h1 align="center">Update Lecturer Profile</h1>
<div id="form-wrapper" style="max-width:1200px;margin:auto;">

<div class="Update_Lecturer_Profile"> 
  <form action="/action_page.php">
    <label for="fname">Edit Your First Name</label>
    <input type="text" id="title" name="title" placeholder="Edit Your First Name..">

    <label for="lname">Edit Your Last Name</label>
    <input type="text" id="title" name="title" placeholder="Edit Your Last Name..">
	
    <label for="brd">Edit Your Date of Birth</label>
    <input type="date" id="title" name="title">

    <label for="nic">Edit Your NIC Number</label>
    <input type="text" id="title" name="title" placeholder="Edit Your NIC Number..">

    <label for="email">Edit Your Email</label>
    <input type="text" id="title" name="title" placeholder="Edit Your Email..">

    <label for="equl">Edit Your Education Qualification</label>
    <textarea type="textarea" id="l_des" name="l_des" placeholder="Edit Your Education Qualification.."></textarea>

    </br>

    <button type="button" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Save Changes</button>
