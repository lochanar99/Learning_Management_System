    ...
    <div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Get In Touch</h3>
                <p class="lead">Job Opportunities for the Students.</p>
            </div><!-- end title -->
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        ...
                        <h3> Bharti Airtel Lanka </h3>
                        <p>Details the latest technology in treating eye Reviews intraocular lens implants, biocompatibility of materials, retinal implants, testing models, and software designs</p>
                    </div><!-- end service -->
                </div><!-- end col -->
...
<br>		  
    ...
    <section class="section nopad cac text-center">
        <a href="#"><h3>Failure doesn't mean you are a failure it just means you haven't succeeded yet!</h3></a> <br>
    </section>
