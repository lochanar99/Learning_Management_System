...
<body>
    ...
    <div class="all-page-title" style="background-image:url(images/deco4.jpg);">
    ...
    <br><br>
     ...
     <h2 align="center">Lab Items Update Delete Menu</h2>
  ...
  <tbody>
  @foreach($Lab_Item_View as $lp)
    <tr>
      <th scope="row">1</th>
      <td>{{$lp->ItemCode}}</td>
      <td>{{$lp->ItemName}}</td>
      <td>{{$lp->CurrentItem}}</td>
      <td>{{$lp->RequiredItem}}</td>
      <td>{{$lp->Quantity}}</td>
      <td>{{$lp->Status}}</td>
