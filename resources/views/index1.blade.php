...
<body class="seo_version">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <br>
                        ...
                        <a href="http://127.0.0.1:8000/AddStudent" class="btn btn-light btn-radius btn-brd ban-btn">&nbsp;&nbsp;Student Details&nbsp;&nbsp;</a>&nbsp;&nbsp;
                        <a href="http://127.0.0.1:8000/Students" class="btn btn-light btn-radius btn-brd ban-btn">New Student Details</a><br><br>
                        <a href="http://127.0.0.1:8000/AddCourse" class="btn btn-light btn-radius btn-brd ban-btn">&nbsp;&nbsp;&nbsp;Course Details&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;
                        <a href="http://127.0.0.1:8000/Courses" class="btn btn-light btn-radius btn-brd ban-btn">&nbsp;New Course Details&nbsp;</a><br><br>
    ...
    <svg id="clouds" class="hidden-xs" xmlns="http://www.w3.org/2000/svg" version="1.1" width="130%" height="130" viewBox="0 0 85 100" preserveAspectRatio="none">
