...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Admin Carrier Guidence</title>  
...
<div class="all-page-title" style="background-image:url(images/pattern-4.png);">
    ...
    <div id="services" class="section lb">
        ...
        <div class="col-md-12">
            ...
            <form method="post" action="/AdminCarrierGuide">
            {{csrf_field()}}
            
            <input type="text" class="form-control" name="CarName" placeholder="Carrier Name">
            <br>
            ...
            <a href="/AdminCarrierGuide" class="btn btn-warning">CLEAR</a>
            </form>
            <br><br>
            ...
            <table class="table table-light">
                    ...
                    <tr>
                    <td>{{$Carrier->CarID}}</td>
                    <td>{{$Carrier->CarName}}</td>
                    <td>{{$Carrier->Desc}}</td>
                    <td>{{$Carrier->LecID}}</td>
                    <td>{{$Carrier->LecName}}</td>
                    <td><a href="/AdminCarrierGuide" class="btn btn-warning">Delete</a></td>
