...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Registeration Lists</title>  
...
<body class="seo_version">
    ...
    <div id="services" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Registeration Lists</h3>
                </div><!-- end title -->
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <img src="uploads/FirstYe.jpg" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3>First Year Lists</h3>
                        <p>Semester 01 and 02</p>
                    </div><!-- end service -->
                </div><!-- end col -->
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <img src="uploads/SecondYe.jpg" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3>Second Year Lists</h3>
                        <p>Semester 03 and 04</p>
						</div><!-- end service -->
                </div><!-- end col -->
            </div><!-- end row -->
    ...
    <section class="section nopad cac text-center">
        <a href="#"><h3>If you can DREAM it, you can DO it.!</h3></a>
    </section>
