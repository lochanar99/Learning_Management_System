            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a href="case-study.html">Student Afirs/Digital Library</a></li>
                        <li><a href="pricing.html">Student Management</a></li>
...
<div class="Change_Password"> 
  <form action="/action_page.php">
    ...
    <input type="password" id="title" name="title" placeholder="Enter Your Current Password..">

    <label for="psw">New Password</label>
    <input type="password" id="title" name="title" placeholder="Enter Your New Password..">

    <label for="psw">Confirm Password</label>
    <input type="password" id="title" name="title" placeholder="Re-Enter Your New Password..">
    ...
    <div class="container">
    <button type="reset" class="cancelbtn">Cancel</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
