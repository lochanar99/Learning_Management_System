...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Admin Digital Library and Student Affairs</title>  
...
<header class="header header_style_01">
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-4.png);">
        <div class="container text-center">
            <h1>Digital Library and Student Affairs</h1>
        </div>
		<!--Page -->
           <div class="page-info">
            <div class="container">
    ...
    <div id="services" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Digital Library and Student Affairs</h3>
                </div><!-- end title -->
            <div class="row text-center">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href='AdminDigitalLib'> <img src="uploads/Library.jpg" alt="" class="img-responsive img-rounded"  >
                        </div>
                        <h3><a href='AdminDigitalLib'>Digital Library</h3>
                    </div><!-- end service -->
                </div><!-- end col -->
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href="#"><img src="images/logos/logo-light.png" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3></h3>
                        <p></p>
						</div><!-- end service -->
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="service-widget">
                        <div class="post-media wow fadeIn">
                            <a href='AdminStudentAffairs'> <img src="uploads/studentAffairs.jpg" alt="" class="img-responsive img-rounded">
                        </div>
                        <h3> <a href='AdminStudentAffairs'> Student Affairs</h3>
						</div><!-- end service -->
                </div><!-- end col -->
            </div><!-- end row -->
    ...
    <section class="section nopad cac text-center">
        <a href="#"><h3>Desire! That's the one secret of every man's career. Not education. Not being born with hidden talents. Desire.</h3></a>
    </section>
