            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        <li><a href="/indexx">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAbout </a></li>
    ...
    <svg id="clouds" class="hidden-xs" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 85 100" preserveAspectRatio="none">
        <path d="M-5 100 Q 0 20 5 100 Z
            ...
            <div class="container">
                ...
                <form action="/updateEventView" method="post">

                    {{ csrf_field() }}

                    Student ID:<input type="text" class="form-control" name="stdId" value="{{$eventdata->stdId}}"><br><br>
                    Student Name:<input type="text" class="form-control" name="stdName" value="{{$eventdata->sName}}"> <br><br>
                    Event Date:<input type="date" class="form-control" name="eDate" value="{{$eventdata->eDate}}"> <br><br>
                    Event Venue<input type="text" class="form-control" name="eVenue" value="{{$eventdata->eVenue}}"> <br><br>
                    No. of Participants:<input type="text" class="form-control" name="ePartici" value="{{$eventdata->ePartici}}"> <br><br>
                    Telephone No.:<input type="text" class="form-control" name="eTel" value="{{$eventdata->sTel}}">  <br><br>

                    <input type="hidden" name="Eid" value={{$eventdata->Eid}}>
