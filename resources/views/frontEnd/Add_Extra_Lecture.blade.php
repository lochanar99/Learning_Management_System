...
<body class="seo_version">
            ...
            <div class="container">
            	<div class="inner-container">
                    <ul class="bread-crumb">
                        <li><a href="{{url('Add_Extra_Lecture')}}"><span>Add Extra Lecture</span></a></li>
    ...
    <svg id="clouds" class="hidden-xs" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 85 100" preserveAspectRatio="none">
 	...
 	<form method="post" action="/saveLec">
     {{csrf_field()}}
 		<div class="container">
  		Student ID:
  			...
  			<br><br>
  			Module ID:&nbsp&nbsp&nbsp&nbsp
  			<input type="text" class="form-control" name="modId"  placeholder="OPXX">
  			<br><br>
  			Module Name:
  			<input type="text" class="form-control" name="modName"  placeholder="">
  			<br><br>
  			Date Possible:
  			<input type="date" class="form-control" name="datePos" placeholder ="">
  			<br><br>
  			Tel-Number
  			<input type="text" class="form-control" name="eTel"  placeholder="eg:770688895">
...
<div class="container text-center">
		...
		<button class="btn btn-warning"  id="cLec" class="float-left submit-button" ><a href="{{url('show_current_lecs')}}">View Extra Lectures</a></button>
</div>
