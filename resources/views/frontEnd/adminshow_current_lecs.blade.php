...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Current Extra Lectures</title>  
...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        <li><a href="/indexx">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAbout </a></li>
        ...
        <div class="page-info">
            <div class="container">
            	<div class="inner-container">
                    ...
                    <li><a href="/aCurrentLecs"><span>Extra Lectures</span></a></li>
                        <li><a href="/aCurrentEvents">Events</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <table class ="table table-dark">
                        ...
                        @foreach($show_current_lecs as $cLecs)
                            <tr>
                                <td>{{$cLecs->Eid}}</td>
                                <td>{{$cLecs->stdId}}</td>
                                <td>{{$cLecs->sName}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="/deleteLec/{{$cLecs->Eid}}" class="btn btn-danger">Delete</a>
                                    <a href="/updateLec/{{$cLecs->Eid}}" class="btn btn-success">Update</a>
                                    <a href="/markApprovals/{{$cLecs->Eid}}" class="btn btn-primary">Approve</a><br><br>
                                    <a href="/markDisApprovals/{{$cLecs->Eid}}" class="btn btn-warning">Disapprove</a>
