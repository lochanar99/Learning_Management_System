    ...
    <svg id="clouds" class="hidden-xs" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 85 100" preserveAspectRatio="none">
        <path d="M-5 100 Q 0 20 5 100 Z
            ...
            <div class="container">
                ...
                <form action="/updateLecView" method="post">

                    {{ csrf_field() }}

                    Student ID:<input type="text" class="form-control" name="stdId" value="{{$lecdata->stdId}}"><br><br>
                    Student Name:<input type="text" class="form-control" name="stdName" value="{{$lecdata->sName}}"> <br><br>
                    Module ID:<input type="text" class="form-control" name="modId" value="{{$lecdata->mId}}"> <br><br>
                    Module Name:<input type="text" class="form-control" name="modName" value="{{$lecdata->mName}}"> <br><br>
                    Date Possible:<input type="date" class="form-control" name="datePos" value="{{$lecdata->eDate}}"> <br><br>
                    Telephone No.:<input type="text" class="form-control" name="eTel" value="{{$lecdata->sTel}}">  <br><br>

                    <input type="hidden" name="Eid" value={{$lecdata->Eid}}>
