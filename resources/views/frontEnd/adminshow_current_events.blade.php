...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        <li><a href="/indexx">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAbout </a></li>
        ...
        <div class="page-info">
            <div class="container">
            	<div class="inner-container">
                    ...
                    <li><a href="/aCurrentLecs">Extra Lectures</a></li>
                        <li><a href="/aCurrentEvents"><span>Events</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <table class ="table table-dark">
                        ...
                        @foreach($show_current_events as $cEvents)
                            <tr>
                                <td>{{$cEvents->Eid}}</td>
                                <td>{{$cEvents->stdId}}</td>
                                <td>{{$cEvents->sName}}</td>
                                <td>{{$cEvents->eDate}}</td>
                                <td>{{$cEvents->eVenue}}</td>
                                <td>{{$cEvents->ePartici}}</td>
                                <td>{{$cEvents->sTel}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="/deleteEvent/{{$cEvents->Eid}}" class="btn btn-danger">Delete</a>
                                    <a href="/updateEvent/{{$cEvents->Eid}}" class="btn btn-success">Update</a>
                                    <a href="/markApproval/{{$cEvents->Eid}}" class="btn btn-primary">Approve</a><br><br>
                                    <a href="/markDisApproval/{{$cEvents->Eid}}" class="btn btn-warning">Disapprove</a>
