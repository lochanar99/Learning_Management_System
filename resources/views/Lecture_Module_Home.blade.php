...
<h1 align="center"><font size="12">OPTOMETRY & VISION SCIENCE</font></h1>
...
<div class="dropdown">
  <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp First Year &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
  <div class="dropdown-content">
  <a href="{{url('lec1st1sem')}}">First Semester</a>
  <a href="{{url('lec1st2sem')}}">Second  Semester</a>
  </div>
</div>


<div class="dropdown">
  <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Second Year &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
  <div class="dropdown-content">
  <a href="{{url('lec2nd1sem')}}">First Semester</a>
  <a href="{{url('lec2nd2sem')}}">Second  Semester</a>
  </div>
</div>
