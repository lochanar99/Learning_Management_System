        ...
        <div class="content-wrapper1">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h1 class="card-title"><center>Module 1</center></h1>
                  ...
                  <table class="table table-striped">
                    ...
                    @foreach($tasks as $tasks)
                      <tr>
                        ...
                        <td>
                          <a href="/deletetask/{{$tasks->id}}" class=""btn btn-success mr-2">Delete</a>
                        </td>
                        <td>
              ...
              <a href="{{url('Lecture_Upload_Lecture')}}"><button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Add Lecture</button></a>&nbsp
              <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Lecture Manage</button>
