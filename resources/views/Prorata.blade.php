...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Prorata Registeration</title>  
   ...
   <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Prorata Registeration</h3>
				<p> Register One Module at a Time</p>
            </div><!-- end title -->
								...
								<div id="message"></div>
									<form id="contactform" class="row" action="contact.php" name="contactform" method="post">
										<fieldset class="row-fluid">
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="pay" id="pay" class="form-control" placeholder="The Amount You Paid" required>
												</div>
												
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<label class="sr-only">Your Semester</label>
													<select name="select_service" id="select_service" class="selectpicker form-control" data-style="btn-white">
															<option value="sem1">Semester 01</option>
															<option value="sem2">Semester 02</option>
															<option value="sem3">Semester 03</option>
															<option value="sem4">Semester 04</option>
													</select>
												</div>
												
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<textarea class="form-control" name="sub" id="sub" rows="6" placeholder="Module Name"></textarea>
												</div>
