...
<body class="seo_version">
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-9.jpg);">
    ...
    <div class="row">
     <div class="col-md-12">
         ...
         @endforeach
         <form method="post" action="/saveNotice">
            {{csrf_field()}}

        <input type="text" class="form-control" name="notice1" placeholder="Enter your notice here ">
<br>
        ...
        <table class="table table-dark">
            ...
            @foreach ($enotices as $notice)
            <tr>
                <td>{{$notice->Nid}}</td>
                <td>{{$notice->Ncontent}}</td>
                <td><a href="/deleteNotice/{{$notice->Nid}}" class="btn btn-warning">Delete</a>
                <a href="/updateNotice/{{$notice->Nid}}" class="btn btn-success">Update</a></td>
            </tr>
            @endforeach
        </table>
