...
<body class="seo_version">
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <li><a href="/index">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAbout</a></li>
    ...
    <div class="all-page-title" style="background-image:url(images/pattern.jpeg);">
    ...
    <div id="support" class="section db">
        <div class="container">
            <div class="section-title text-center">
                <h3>We Will Inform You When There Is a Exam!</h3>
            </div><!-- end title -->
