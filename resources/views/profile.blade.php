            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a href="services.html">Event/Extra Lectures</a></li>
                        <li><a href="/aEvents">Student Afirs/Digital Library</a></li>
...
<div class="Registration_form"> 
  ...
  <!--@foreach($registration as $reg)-->
       ...
       <div class="row">
        <div class="col-sm-4"> <img class="img-thumbnail img-responsive" src="images/pro1.png" width="250px" height="250px"></div>
        <div class="col-sm-8">
           <div class="row">
           <div class="col-sm-15"><label></label></div>
          ...
          <div class="row">
           <div class="col-sm-15"><h2>{{$reg->firstname}} {{$reg->lastname}}</h2></div>
           
       </div>
        <div class="row">
           <div class="col-sm-15"><h2>{{$reg->equli}}</h2></div>
          
       </div>
        <div class="row">
           <div class="col-sm-15"><hr1></div>
      ...
      <div class="row">
        <div class="col-sm-4"><button type="reset" value="SEND" id="submit" class="button1">Update</button></div>
        <div class="col-sm-8">
          <div class="row">
           <div class="col-sm-4"><label>Lecturer ID</label></div>
           <div class="col-sm-4"><p>{{$reg->lid}}</p></div>
       </div>
           <div class="row">
           <div class="col-sm-4"><label>First Name</label></div>
           <div class="col-sm-4"><p>{{$reg->firstname}}</p></div>
       </div>
           <div class="row">
           <div class="col-sm-4"><label>Last Name</label></div>
           <div class="col-sm-4"><p>{{$reg->lastname}}</p></div>
       </div>
            <div class="row">
           <div class="col-sm-4"><label>Date of Birth</label></div>
           <div class="col-sm-4"><p>{{$reg->dob}}</p></div>
       </div>
           <div class="row">
           <div class="col-sm-4"><label>NIC Number</label></div>
           <div class="col-sm-4"><p>{{$reg->nic}}</p></div>
       </div>
           <div class="row">
           <div class="col-sm-4"><label>Email</label></div>
           <div class="col-sm-4"><p>{{$reg->lemail}}</p></div>
       </div>
           <div class="row">
           <div class="col-sm-4"><label>Education Qualification</label></div>
           <div class="col-sm-4"><p>{{$reg->equli}}</p></div>
       </div>
      </div>
     </div>
    <!-- @endforeach-->
        ...
        <div class="col-sm-4">
          <div class="row">
           ...
           <div class="col-sm-1"><a href="/updateprofile"><button type="button" value="SEND" id="submit" class="button">Update</button></a></div>
       </div>
      </div>
     </div>
...
<hr>
        <div class="row">
        <div class="col-sm-4"><button type="reset" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Delet Acount</button></div>
        <div class="col-sm-4"><a href="/viewfeedback"><button type="reset" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Feedbacks</button></a></div>
        <div class="col-sm-4"><a href="/changepassword"><button type="reset" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Change Password</button></a></div>
      </div>
