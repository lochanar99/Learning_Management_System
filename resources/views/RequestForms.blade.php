...
<body class="seo_version">
   ...
   <header class="header header_style_01">
    ...
    <div id="pricing" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Request Forms</h3>
                <p class="lead"> Get our assists for your betterment of Studies!</p>
            </div><!-- end title -->
                            ...
                            <div class="row text-center">
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        <div class="pricing-table-header grd1">
                                            <h2>Transform Letter</h2>
                                        </div>
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/Transf.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='Transfer' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/Certf.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='Certificate' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/Offif.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='Oficial' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        <div class="pricing-table-header grd1">
                                            <h2>Postponment Form</h2>
                                        </div>
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/postf.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='Postpone' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        <div class="pricing-table-header grd1">
                                            <h2>Prorata Registerartion</h2>
                                        </div>
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/Prof.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='Prorata' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        <div class="pricing-table-header grd1">
                                            <h2>Results Sheet Request</h2>
                                        </div>
                                        <div class="pricing-table-space"></div>
										<div class="post-media wow fadeIn">
											<img src="uploads/Resf.jpg" alt="" class="img-responsive img-rounded">
										</div>
                                        <div class="pricing-table-sign-up">
                                            <a href='ResultsReq' class="btn btn-light btn-radius btn-brd grd1 effect-1">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="section nopad cac text-center">
        <a href="#"><h3>Dreams are extremely important. You can't do it unless you imagine it.</h3></a><br>
    </section>
