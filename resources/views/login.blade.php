            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right hidden-md hidden-sm hidden-xs">
                        <li><a class="btn-light btn-radius btn-brd top-btn" href="/registration"><i class="fa fa-angle-double-right"></i>Registration</a></li>
                    </ul>
...
<div class="Lecturer_Login_form"> 
  <form action="/action_page.php">
    <label for="uname">Username</label>
    <input type="text" id="sname" name="uname" placeholder="Enter Userame..">
    ...
    <button type="button" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Login</button>
