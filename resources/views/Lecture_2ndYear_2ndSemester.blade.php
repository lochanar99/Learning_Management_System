            ...
            <div class="container">
            	<div class="inner-container">
                    ...
                    <li><a href="{{url('index')}}">Home</a></li>
                        ...
                        <li><a href="{{url('Lecture_Upload_Lecture')}}">Upload Lecture</a></li>
                        <li><a href="{{url('lecturemanagement')}}">Lecture Management</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<h1 align="center"><font size="12">Second Semester</font></h1>
<div id="form-wrapper" style="max-width:1200px;margin:auto;">
    ...
    <ul style="list-style-type:square;" >
        <li><font size="6"><b><a href="Lecture_Module_Page.htmlLecture_Module_Page.htmlLecture_Module_Page.html">Optometry Clinics </a></li>
        <li><a href="Lecture_Module_Page.htmlLecture_Module_Page.html">Clinical Experience 4</a></li>
        <li><a href="Lecture_Module_Page.htmlLecture_Module_Page.html">Clinical Ocular Pharmacology</a></li>
        <li><a href="Lecture_Module_Page.htmlLecture_Module_Page.html">Strabismus and Aniseikonia</a></li>
        <li><a href="Lecture_Module_Page.htmlLecture_Module_Page.html">Professional Ethics & Optometric Communication</a></li>
        <li><a href="Lecture_Module_Page.htmlLecture_Module_Page.html">Practice Management</a></li></b></font>
    </ul>
