...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Certifcate Request Form</title>  
									...
									<form id="contactform" class="row" action="contact.php" name="contactform" method="post">
										<fieldset class="row-fluid">
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<label class="sr-only">Select Cerificate Course</label>
													<select name="select_service" id="select_service" class="selectpicker form-control" data-style="btn-white">
															<option value="dip1">Diploma in Opthalamic</option>
															<option value="dip2">Diploma in Visuals</option>
															<option value="dip3">Diploma in Eye Sight</option>
															</select>
												</div>
