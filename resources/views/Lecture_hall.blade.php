...
<body>
    ...
    <br> <br> <br> <br> <br> <br> <br> <br> <br>
     ...
     <div class="all-page-title" style="background-image:url(images/medi.png);">
	...
	<li><a class="active" href="/lechall">Lecture hall</a></li>
    ...
    <h2 align="center">Lecture Hall Items</h2>
    ...
    {{csrf_field()}}
		...
		<input type="text" name="lec" value="" placeholder="Enter item code" >
		<br>
		<label>Item Name</label>
		<input type="text" name="lecname" value="" placeholder="Enter item name" >
		<br>
		<label>Hall No</label>
		<input type="text" name="lecno" value="" placeholder="Enter hall number">
		<br>
		<label>Quantity</label>
		<input type="text" name="lecqty" value="" placeholder="Enter Quantity">
		<br>
		<label>Status</label>
    ...
    <div class="col-auto my-1">
      ...
      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="lecdrop">
        ...
        <a href="/lechallItem"><button  type="button" class="btn btn-danger btn-primary btn-lg" >Update/Delete</button></a>
