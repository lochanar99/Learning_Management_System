   ...
   <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Postponement Registeration Form</h3>
            </div><!-- end title -->
								...
								<div id="message"></div>
									<form id="contactform" class="row" action="contact.php" name="contactform" method="post">
										<fieldset class="row-fluid">
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<input type="text" name="semi" id="semi" class="form-control" placeholder="Your Finished Semester" required>
												</div>
												
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<label class="sr-only">Skiping Semester</label>
													<select name="select_service" id="select_service" class="selectpicker form-control" data-style="btn-white">
															<option value="semi1">Skip Semester 01</option>															
															<option value="semi2">Skip Semester 02</option>
															<option value="semi3">Skip Semester 03</option>
															<option value="semi4">Skip Semester 04</option>
													</select>
												</div>
												
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<textarea class="form-control" name="comnts" id="comnts" rows="6" placeholder="Reasons for Your Postponement"></textarea>
												</div>
