...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Admin Institute Manuals</title>  
...
<div class="all-page-title" style="background-image:url(images/pattern-4.png);">
    ...
    <div id="services" class="section lb">
        ...
        <div class="col-md-12">
            ...
            {{csrf_field()}}
            <input type="text" class="form-control" name="CarID" placeholder="Manual ID">
            <br>
            <input type="text" class="form-control" name="CarName" placeholder="Manual Nmae">
            <br>
            <input type="text" class="form-control" name="Desc" placeholder="Description">
            <br>
            <input type="text" class="form-control" name="LecID" placeholder="Lecturer ID">
            <br>
            <input type="text" class="form-control" name="LecName" placeholder="Lecturer Nmae">
            <br>
