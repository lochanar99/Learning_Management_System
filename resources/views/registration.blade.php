            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right hidden-md hidden-sm hidden-xs">
                        <li><a class="btn-light btn-radius btn-brd top-btn" href="/login"><i class="fa fa-angle-double-right"></i>Login</a></li>
                    </ul>
...
<div class="Registration_form"> 
  ...
  {{csrf_field()}}
    ...
    <input type="text" id="finame" name="finame" placeholder="Enter Your First Name..">

    <label for="lname">Last Name</label>
    <input type="text" id="laname" name="laname" placeholder="Enter Your Last Name..">
	
    <label for="brd">Date of Birth</label>
    ...
    <input type="text" id="lmail" name="lmail" placeholder="Enter Your Email..">

    <label for="equl">Education Qualification</label>
    <textarea type="textarea" id="ldes" name="ldes" placeholder="Enter Your Education Qualification.."></textarea>

    <label for="psw">Password</label>
    <input type="password" id="psw" name="psw" placeholder="Enter Your Password..">

    <label for="psw">Confirm Password</label>
    <input type="password" id="cpsw" name="cpsw" placeholder="Re-Enter Your Password..">

    </br>

    <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Register</button>
